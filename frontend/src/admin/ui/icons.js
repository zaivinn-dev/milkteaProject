...
export function IconCategories({ className = base }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
...
export function IconOrders({ className = base }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
...
export function IconAnalytics({ className = base }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
...
export function IconSettings({ className = base }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
...
export function NavIcon({ name, className }) {
  const Icon = NAV_ICONS[name] || IconDashboard;
...
export const ADMIN_SECTION_META = {
  dashboard: { title: 'Dashboard', description: 'Overview of orders and revenue' },
  categories: { title: 'Categories', description: 'Organize your drink menu' },
  menu: { title: 'Menu', description: 'Manage drinks, sizes, and prices' },
  orders: { title: 'Orders', description: 'Full order history' },
  analytics: { title: 'Analytics', description: 'Sales trends and insights' },
  settings: { title: 'Settings', description: 'Accounts, staff, and system' }
};
